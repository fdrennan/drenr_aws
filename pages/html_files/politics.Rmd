...
The function below creates a binary indicator stating wether the person is Republican or not. I'm only curious about Democrats and Republicans, so I filter out Independents. Finally, I create a column `years_in_office` which is self explanatory.
